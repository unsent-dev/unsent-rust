...
let email = EmailCreate {
    ...
    html: Some("<p>Unsent is the best open source product to send emails</p>".to_string()),
    text: Some("Unsent is the best open source product to send emails".to_string()),
    reply_to: None,
    cc: None,
    bcc: None,
    attachments: None,
